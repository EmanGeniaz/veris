...
const foot = pack => `\n\n---\n_Generated from GenVeris Template Library · ${pack} · pre-filled from the canonical control set. Fill the bracketed fields, then attach to the initiative to record evidence._`;
  ...
  },
  {
    ...
    artifacts: [
      ...
      { id: "cn-checklist", name: "Cross-Instrument Obligation Checklist", kind: "Checklist", build: () => [
        ...
        "| # | Obligation | Instrument | GenVeris control | Status |",
        "| --- | --- | --- | --- | --- |",
