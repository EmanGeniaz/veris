...
export const UNIFIED_INCIDENTS = [
  ...
  { id: "INC-1048", title: "Cross-border data flow without transfer mapping (APAC)", cls: "Regulatory", severity: "P2 · High",   sev: "warn", system: "Predictive Maintenance",       initiativeId: "pf-maint", owner: "Priya Mehta · CDPO", detected: "3d ago",       status: "Contained",     st: "good", reg: "GDPR Art.44 transfer impact assessment complete — mapping in place" },
