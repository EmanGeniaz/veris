/* ── Global AI Framework Library ──────────────────────────────────────────
   GenVeris ships the whole landscape hardcoded, not a subset. No single
   ...
   `status` is how far GenVeris operationalises each one today:
...
import { UAE_POSTURE_SCORE } from "./uae-mappings";
...
import { ISO22989_POSTURE_SCORE, ISO23053_POSTURE_SCORE, ISO24027_POSTURE_SCORE, ISO25059_POSTURE_SCORE, ISO5338_POSTURE_SCORE } from "./lifecycle-standards";
...
export const FRAMEWORKS = [
  ...
  { id: "uae-pdpl", name: "UAE / Dubai Data & AI Regulation", body: "UAE (Data Office · DIFC · ADGM · DESC)", cat: "regional", type: "Law + free-zone + security", obligation: "Binding law", applies: ["ae"], focus: "6 instruments — Federal PDPL (Decree-Law 45/2021), DIFC DP Law 5/2020, ADGM DP Regs 2021, DESC information-security & cloud, national IA baseline, UAE AI ethics", bestFor: "Governing AI & personal data across the UAE, DIFC, ADGM and Dubai", status: "Operational", score: UAE_POSTURE_SCORE },
  ...
  { id: "iso-22989", name: "ISO/IEC 22989", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "AI concepts & terminology", bestFor: "Shared terminology across the AI program", status: "Operational", score: ISO22989_POSTURE_SCORE },
  { id: "iso-23053", name: "ISO/IEC 23053", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "Framework for ML-based AI systems", bestFor: "ML system architecture & lifecycle", status: "Operational", score: ISO23053_POSTURE_SCORE },
  { id: "iso-24027", name: "ISO/IEC 24027", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "Bias in AI systems & AI-aided decision making", bestFor: "Bias assessment & fairness", status: "Operational", score: ISO24027_POSTURE_SCORE },
  { id: "iso-25059", name: "ISO/IEC 25059", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "Quality model for AI systems", bestFor: "AI system quality evaluation", status: "Operational", score: ISO25059_POSTURE_SCORE },
  { id: "iso-5338", name: "ISO/IEC 5338", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "AI system lifecycle processes", bestFor: "Lifecycle process definition", status: "Operational", score: ISO5338_POSTURE_SCORE },
