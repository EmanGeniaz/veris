...
export const FRAMEWORKS = [
  ...
  { id: "nist-genai", name: "NIST GenAI Profile (600-1)", body: "NIST (US)", cat: "foundational", type: "Profile / guidance", obligation: "Voluntary", applies: ["global"], focus: "Risks unique to generative AI / LLMs", bestFor: "GenAI & LLM-specific risk considerations", status: "Mapped", score: 58 },
  ...
  { id: "iso-23894", name: "ISO/IEC 23894", body: "ISO (Intl.)", cat: "foundational", type: "Guidance", obligation: "Guidance", applies: ["global"], focus: "AI-specific risk management (identify, assess, treat, monitor)", bestFor: "AI risk assessment & treatment guidance", status: "Mapped", score: 60 },
  { id: "oecd", name: "OECD AI Principles", body: "OECD (Intl.)", cat: "foundational", type: "Policy principles", obligation: "Principles", applies: ["global"], focus: "Values-based principles for trustworthy AI (updated 2024)", bestFor: "High-level policy alignment & stakeholder trust", status: "Mapped", score: 66 },
  { id: "unesco", name: "UNESCO AI Ethics Recommendation", body: "UNESCO (UN)", cat: "foundational", type: "International recommendation", obligation: "Recommendation", applies: ["global"], focus: "Human rights, ethics & social impact (adopted by 194 countries)", bestFor: "Ethical baseline & global responsible-AI alignment", status: "Mapped", score: 63 },
  ...
  { id: "sg-model", name: "Singapore Model AI Governance (GenAI & Agentic)", body: "Singapore", cat: "regional", type: "Framework + guidance", obligation: "Voluntary", applies: ["sg"], focus: "Practical governance for AI, GenAI and agentic AI (updated 2026)", bestFor: "Implementing AI/agent governance with practical controls", status: "Mapped", score: 64 },
  ...
  { id: "au-safety", name: "Australia Voluntary AI Safety Standard", body: "Australia", cat: "regional", type: "Voluntary standard", obligation: "Voluntary", applies: ["au"], focus: "10 AI guardrails (accountability, transparency, security, human oversight, …)", bestFor: "Building safe & reliable AI aligned to best practice", status: "Mapped", score: 55 },
  { id: "china-regs", name: "China AI Regulations (Algorithm, GenAI, …)", body: "China", cat: "regional", type: "Regulations", obligation: "Binding law", applies: ["cn"], focus: "Algorithm recommendation, deep synthesis, GenAI measures, content labelling", bestFor: "Operating AI products & services in China", status: "Library" },
  ...
  { id: "korea-act", name: "South Korea AI Act & National Strategy", body: "South Korea", cat: "regional", type: "Law + strategy", obligation: "Binding law", applies: ["kr"], focus: "High-impact AI transparency, safety, accountability, national capability", bestFor: "AI governance & compliance in South Korea", status: "Library" },
  { id: "brazil-framework", name: "Brazil AI Regulatory Framework (in progress)", body: "Brazil", cat: "regional", type: "Proposed law", obligation: "Proposed law", applies: ["br"], focus: "Risk classification, rights, transparency, high-risk AI obligations", bestFor: "Preparing for Brazil's upcoming AI regulation", status: "Library" },
  ...
  { id: "iso-38507", name: "ISO/IEC 38507", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "Governance implications of the use of AI by organizations", bestFor: "Board-level AI governance", status: "Mapped" },
  { id: "iso-42005", name: "ISO/IEC 42005", body: "ISO (Intl.)", cat: "lifecycle", type: "Standard", obligation: "Standard", applies: ["global"], focus: "AI system impact assessment", bestFor: "Structured AI impact assessment", status: "Mapped" },
