/* ── India DPDPA regulatory pack ──────────────────────────────────────────
   ...
   obligation mapped to a control GenVeris already runs. Posture is COMPUTED
...
/* Each obligation → the GenVeris control that meets it, its surface, status,
...
export const IN_REQS = [
  ...
  { n: 7,  name: "Breach notification to DPB & principals", inst: "dpdp-rules", desc: "Notify the Data Protection Board and affected data principals of a personal-data breach (s.8(6) + Rules).", control: "Breach-notification workflow — DPB + principal notices on the DPDP clock, decision + evidence logged", surface: "Breach Notification", status: "Met" },
