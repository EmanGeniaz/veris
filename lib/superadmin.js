...
export const SA_MODULE_GROUPS = [
  ...
  { id: "ciso", area: "Executive", label: "CISO Security", note: "Chief Information Security Officer", modules: [
    { id: "ciso_enforce", label: "Veris Enforce" }, { id: "ciso_coverage", label: "Enforcement Coverage" }, { id: "ciso_authority", label: "Agent Authority" }, { id: "ciso_ledger", label: "Tool-Call Ledger" },
  ...
  { id: "cgo", area: "Executive", label: "CGO Compliance", note: "Chief Compliance & Governance Officer", modules: [
    { id: "cgo_forum", label: "Governance Forum" }, { id: "cgo_incidents", label: "Incident Playbook" }, { id: "cgo_breach", label: "Breach Notification" }, { id: "cgo_aia", label: "Impact Assessments" }, { id: "cgo_dataprov", label: "Data Provenance" }, { id: "cgo_carbon", label: "Environmental Footprint" }, { id: "cgo_arabic", label: "Arabic Briefing (العربية)" }, { id: "cgo_crosswalk", label: "Convergence Crosswalk" },
    ...
    { id: "cgo_art12", label: "Article 12 Log" }, { id: "cgo_enforce", label: "Veris Enforce" }, { id: "cgo_coverage", label: "Enforcement Coverage" }, { id: "cgo_ledger", label: "Tool-Call Ledger" },
...
export const SA_OPERATORS = [
  { id: "op-root", name: "Platform Operator", email: "root@genveris.ai", scope: "All organizations", status: "Owner" },
  { id: "op-2", name: "Sam Rivera", email: "sam.rivera@genveris.ai", scope: "All organizations", status: "Operator" },
];
