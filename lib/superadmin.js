...
export const SA_MODULE_GROUPS = [
  ...
  { id: "cgo", area: "Executive", label: "CGO Compliance", note: "Chief Compliance & Governance Officer", modules: [
    { id: "cgo_forum", label: "Governance Forum" }, { id: "cgo_incidents", label: "Incident Playbook" }, { id: "cgo_breach", label: "Breach Notification" }, { id: "cgo_crosswalk", label: "Convergence Crosswalk" },
