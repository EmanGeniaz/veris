...
export const NISTRMF_REQS = [
  ...
  { n: 3, name: "Map — impacts to individuals & society", desc: "Identify potential impacts on people and groups.", control: "AI Impact Assessment (AIA) workflow", surface: "Risk Center · AIA", status: "Partial" },
  ...
  { n: 7, name: "Manage — third-party & incident response", desc: "Manage third-party risk and respond to incidents.", control: "Vendor risk review + incident register", surface: "AI Incidents", status: "Partial" },
];
...
export const ISO42001_REQS = [
  ...
  { n: 4, name: "AI system impact assessment", desc: "Assess impacts to individuals & society (A.5).", control: "AI Impact Assessment (AIA) workflow", surface: "Risk Center · AIA", status: "Partial" },
  ...
  { n: 6, name: "Data for AI systems", desc: "Govern data quality, provenance & suitability (A.7).", control: "Data governance record + model card provenance", surface: "AI Central · Repository", status: "Partial" },
...
export const EUAIACT_REQS = [
  ...
  { n: 4, name: "Data & data governance", desc: "Training/validation data quality & governance (Art.10).", control: "Data governance record + provenance", surface: "AI Central · Repository", status: "Partial" },
  ...
  { n: 7, name: "Transparency to deployers & users", desc: "Instructions & disclosure of AI use (Art.13/50).", control: "AI interaction disclosure + decision transparency", surface: "Decisions / Approvals", status: "Partial" },
  ...
  { n: 10, name: "Post-market monitoring & incident reporting", desc: "Monitor in service and report serious incidents (Art.72/73).", control: "Incident register + drift monitoring", surface: "AI Incidents", status: "Partial" },
];
...
export const GDPR_REQS = [
  ...
  { n: 4, name: "DPIA for high-risk processing", desc: "Assess impact of high-risk processing (Art.35).", control: "AI Impact Assessment / DPIA workflow", surface: "Risk Center · AIA", status: "Partial" },
...
export const NISTSEC_REQS = [
  { n: 1, name: "Data-poisoning defence", desc: "Protect training data integrity.", control: "Data provenance record + validation", surface: "AI Central · Repository", status: "Partial" },
  ...
  { n: 7, name: "Monitoring & incident response", desc: "Monitor for attacks and respond to incidents.", control: "Incident register + drift monitoring", surface: "AI Incidents", status: "Partial" },
];
...
export const OWASP_REQS = [
  ...
  { n: 3, name: "LLM03 — Training-data poisoning", desc: "Tampered or poisoned training data.", control: "Data provenance record + validation", surface: "AI Central · Repository", status: "Partial" },
...
export const ISO27001_REQS = [
  ...
  { n: 7, name: "Incident management", desc: "Manage information-security incidents.", control: "Incident register + escalation path", surface: "AI Incidents", status: "Partial" },
...
export const ISOTR20226_REQS = [
  ...
  { n: 4, name: "Lifecycle environmental impact assessment", desc: "Assess full-lifecycle environmental impact.", control: "No dedicated environmental-impact control yet", surface: "—", status: "Gap" },
  { n: 5, name: "Carbon reporting & disclosure", desc: "Report and disclose emissions from AI.", control: "No carbon-accounting / disclosure control yet", surface: "—", status: "Gap" },
