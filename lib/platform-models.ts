...
export const AC_RBAC: Record<string, ACRoleAccess> = {
  ceo:  { lens: "Executive",  modules: ["dashboard", "strategy", "portfolio", "lifecycle", "value", "controls", "academy", "templates"], focus: "Portfolio, ROI, risk, growth and board metrics" },
  ...
  cfo:  { lens: "Value",      modules: ["dashboard", "portfolio", "value", "repository", "controls", "academy", "templates"], focus: "Budget utilization, ROI confidence and benefit realization" },
  chro: { lens: "Workforce",  modules: ["dashboard", "value", "academy"], focus: "Readiness, adoption resistance and learning completion" },
  ciso: { lens: "Security",   modules: ["dashboard", "repository", "inventory", "gateway", "agents", "controls", "trust", "evidence", "risk"], focus: "Model security, gateway enforcement and control evidence" },
  caio: { lens: "Governance", modules: ["dashboard", "strategy", "portfolio", "repository", "inventory", "lifecycle", "gateway", "agents", "risk", "trust", "evidence", "controls", "policies", "value", "academy", "audit", "templates"], focus: "Implementation, controls, evidence and lifecycle gates" },
  cio:  { lens: "Delivery",   modules: ["dashboard", "strategy", "portfolio", "repository", "inventory", "lifecycle", "gateway", "agents", "controls", "evidence", "academy", "templates"], focus: "Delivery, architecture, platform controls and adoption" },
  cdpo: { lens: "Privacy",    modules: ["dashboard", "inventory", "controls", "policies", "trust", "evidence", "templates"], focus: "DPIAs, data classification and privacy evidence" },
  cgo:  { lens: "Compliance", modules: ["dashboard", "controls", "policies", "evidence", "audit", "academy", "templates"], focus: "Policy compliance, exceptions and audit readiness" },
  cro:  { lens: "Risk",       modules: ["dashboard", "lifecycle", "risk", "controls", "policies", "audit", "evidence", "templates", "agents"], focus: "AI risk framework, controls, operational risk and audit" },
  legal:{ lens: "Legal",      modules: ["dashboard", "policies", "controls", "audit", "evidence", "trust", "templates"], focus: "Regulatory adherence, contracts, IP and legal defensibility" },
...
export const acInitiatives: ACInitiativeRecord[] = [
  {
    ...
    risks: ["Prompt injection", "Data leakage"], roi: "-12%", savings: "$0.2M", revenue: "$0.1M", productivity: "18%", training: "68%", resistance: "Medium",
    ...
    budget: "$1.8M", spent: "$1.5M", timeline: "Jan 2026 - Nov 2026",
  ...
  },
  {
    ...
    status: "Awaiting Approval", priority: "Critical", risk: "Critical", expected: "$7.2M", actual: "$0.0M", stage: "Human Oversight Review",
    ...
    risks: ["Adverse decision harm", "Explainability gap"], roi: "0%", savings: "$0", revenue: "$0", productivity: "11%", training: "54%", resistance: "High",
    ...
    budget: "$2.2M", spent: "$1.9M", timeline: "Oct 2025 - Dec 2026",
  ...
  },
  {
    ...
    budget: "$0.9M", spent: "$0.9M", timeline: "Aug 2025 - Sep 2026",
  ...
  },
  {
    ...
    status: "Risk Assessment", priority: "Medium", risk: "High", expected: "$2.4M", actual: "$0.0M", stage: "Risk Assessment",
    ...
    risks: ["Employee profiling", "Bias in opportunity matching"], roi: "0%", savings: "$0", revenue: "$0", productivity: "7%", training: "39%", resistance: "Medium",
    ...
    budget: "$0.4M", spent: "$0.2M", timeline: "Mar 2026 - Mar 2027",
...
export const EXEC_BRIEF: Record<string, ExecBriefEntry> = {
  ...
  ceo:{focus:"AI Chief Strategy Officer",headline:"Portfolio is scaling, one initiative needs a board-level call.",
    body:"Enterprise AI maturity rose to 78/100 as two pilots reached scale-readiness. Finance Close Automation is board-pack ready and projects $1.6M value; Customer Resolution Copilot is held pending CISO evidence. One initiative is trending to retirement on weak adoption. Approving the scale package unlocks an estimated 9% portfolio ROI uplift this quarter.",
  ...
  cfo:{focus:"AI Financial Advisor",headline:"ROI confidence is strong; one business case is under-delivering.",
    body:"Portfolio ROI confidence is 88% with 6% budget variance. Finance Close Automation is beating its business case (+$1.6M realized vs plan). Credit Decision Assurance is behind on benefits with a 14-month payback slipping. A value-recovery review is recommended before the next investment gate.",
...
export const EXEC_PRIORITIES: Record<string, ExecPriorityItem[]> = {
  ...
  ceo:[
    {title:"Approve Finance Close Automation scale package",owner:"Maya Chen",priority:"Critical",due:"Today",impact:"$1.6M value unlock",benefit:"9% portfolio ROI uplift",link:{ac:"initiatives"}},
...
export const EXEC_RECOMMENDATIONS: Record<string, ExecRecommendationItem[]> = {
  ceo:[
    {action:"Scale Finance Close Automation",metric:"Projected ROI",value:"+78%",rationale:"Readiness 88%, evidence 91%, board-pack ready.",link:{ac:"initiatives"}},
  ...
  caio:[
    {action:"Scale Finance Close Automation",metric:"Projected ROI",value:"+78%",rationale:"Governed scale decision ready to record.",link:{ac:"initiatives"}},
...
export const EXEC_DECISIONS: Record<string, ExecDecisionItem[]> = {
  ceo:[
    {title:"Scale Finance Close Automation to Procurement",context:"Pilot met scale threshold; board pack ready.",impact:"$1.6M value, 88% readiness",risk:"Medium",aiRec:"Approve",evidence:"Scale gate + evidence ledger",link:{ac:"initiatives"}},
...
export const ASSISTANT_NUDGES: Record<string, string[]> = {
  ...
  ceo:["2 governed decisions are waiting for you.","Finance Close Automation is ready to scale (ROI +78%).","One initiative is trending to retirement - review before the board meeting."],
...
export const KPI_INSIGHTS: Record<string, ExecKpiInsight> = {
  ...
  "Model Cards Complete": { rootCause: "4 of 8 registered models lack completed cards.", impact: "Incomplete cards fail ISO 42001 documentation checks.", aiRec: "Auto-draft the 4 missing cards from registry metadata.", link: { ac: "evidence" } },
  ...
  "Drift Detection Cvg.": { rootCause: "All production models wired to drift monitoring; behavioural-shift detection is live.", impact: "Drift is now detected and routed before silent decision degradation.", aiRec: "Maintain thresholds; review flagged shifts in the Drift Monitor.", link: { ac: "initiatives" } },
...
export const riskRegister: RiskRecord[] = [
  ...
  { id: "RSK-005", title: "Explainability gap", system: "Credit Decision Assurance", category: "Transparency",
    ...
    likelihood: 3, impact: 5, residual: 9, level: "High", status: "Monitored",
    ...
    treatment: { strategy: "Mitigate", action: "SHAP explainability layer; automated Art.22 decision explanations; legal disclosure template; model card update.", owner: "CAIO / Legal", deadline: "May 30", status: "Complete", priority: "High" },
...
export const EXEC_RECENT_CHANGES: Record<string, ExecRecentChange[]> = {
  ...
  cfo: [ { what: "Realized ROI updated: Finance Close at 78%, $1.5M savings booked", initiative: "Finance Close Automation", when: "Today", kind: "evidence" }, { what: "Credit Decision benefits re-baselined - $0.4M behind case", initiative: "Credit Decision Assurance", when: "Yesterday", kind: "risk" }, { what: "Gateway routing change cut model spend ~$76K/month", initiative: "Enterprise Gateway", when: "3 days ago", kind: "deployment" } ],
