...
export const AC_RBAC: Record<string, ACRoleAccess> = {
  ...
  caio: { lens: "Governance", modules: ["dashboard", "strategy", "portfolio", "repository", "inventory", "lifecycle", "gateway", "risk", "trust", "evidence", "controls", "policies", "value", "academy", "audit", "templates"], focus: "Implementation, controls, evidence and lifecycle gates" },
  cio:  { lens: "Delivery",   modules: ["dashboard", "strategy", "portfolio", "repository", "inventory", "lifecycle", "gateway", "controls", "evidence", "academy", "templates"], focus: "Delivery, architecture, platform controls and adoption" },
  ...
  cro:  { lens: "Risk",       modules: ["dashboard", "lifecycle", "risk", "controls", "policies", "audit", "evidence", "templates"], focus: "AI risk framework, controls, operational risk and audit" },
