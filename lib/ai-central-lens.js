...
export const AC_LENS = {
  ...
  cro: {
    question: "“Is AI risk inside appetite?” — residual risk, controls and treatment.",
    hero: ["Amber", "Enterprise AI risk", "within appetite · 2 open"],
    kpis: [["Controls effective", "88%", "good", "21/24"], ["Critical risks", "1", "crit", "Credit Decision"], ["Open treatments", "3", "warn", "1 overdue"], ["KRIs breached", "2", "warn", "of 14"]],
    cols: [cName, cRisk, cGuard, cHealth],
  },
  legal: {
    question: "“Can this legally operate?” — obligations, conformity and defensibility.",
    hero: ["88%", "Legally defensible", "1 conformity gap"],
    kpis: [["Controls effective", "88%", "good", "21/24"], ["Conformity gaps", "1", "crit", "EU AI Act"], ["Consent", "98%", "good", "documented"], ["Contracts flagged", "2", "warn", "liability"]],
    cols: [cName, cRisk, cGov, cStage],
  },
  manager: {
