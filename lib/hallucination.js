...
export async function judgeFaithfulness({ answer, context, apiKey, model, fetchImpl, timeoutMs = 20_000 }) {
  ...
  try {
    // Bounded: a hung verifier must never hold the response open. On timeout the
    // fetch aborts and this returns null, falling back to the deterministic verdict.
