...
export const CROSSWALK = [
  ...
  { id: "C08", domain: "Risk & Impact", capability: "Prohibited-practice screening (red lines)", euai: "Art. 5", nist: "MAP 1.1", iso: "A.5.3", sg: "Risk-based approach", artifact: "Prohibited-use attestation", owner: "Legal", status: "gap", note: "The eight red lines are a stop, not a control — no attestation exists yet." },
  ...
  { id: "C12", domain: "Data", capability: "Personal-data protection & residency", euai: "Art. 10(5) · GDPR", nist: "MANAGE 2.2", iso: "A.7 · ISO 27701", sg: "Data quality", artifact: "DPIA + transfer mapping", owner: "CDPO", status: "gap", note: "Open APAC transfer gap (INC-1048) — Art. 44 mapping incomplete." },
  ...
  { id: "C18", domain: "Model & Technical", capability: "Explainability & interpretability", euai: "Art. 13", nist: "MEASURE 2.9", iso: "A.8.2", sg: "Stakeholder interaction", artifact: "Explainability record", owner: "CAIO", status: "gap", note: "Explainability gap (RSK-005) still open on adverse-decision scope." },
  ...
  { id: "C23", domain: "Oversight & Transparency", capability: "GenAI output marking & disclosure", euai: "Art. 50", nist: "GOVERN 4.1", iso: "A.8.3", sg: "Stakeholder interaction", artifact: "AI-content labelling standard", owner: "CAIO", status: "gap", note: "No enterprise standard for marking machine-generated output yet." },
  { id: "C24", domain: "Oversight & Transparency", capability: "GPAI / systemic-risk obligations", euai: "Art. 53 · 55", nist: "MAP 5.1", iso: "A.6.1", sg: "Operations mgmt", artifact: "GPAI provider assessment", owner: "Legal", status: "gap", note: "Accidental-provider test unrun — fine-tune + redistribute triggers Art. 53." },
  ...
  { id: "C27", domain: "Operations & Lifecycle", capability: "Drift & change management", euai: "Art. 72", nist: "MEASURE 2.4", iso: "A.6.2.5", sg: "Operations mgmt", artifact: "Drift monitoring configuration", owner: "Model Risk", status: "gap", note: "Two production models not yet wired to drift monitoring." },
  ...
  { id: "C32", domain: "Assurance & Redress", capability: "Redress & complaint handling", euai: "Art. 85", nist: "GOVERN 5.1", iso: "A.9.3", sg: "Stakeholder interaction", artifact: "Complaints & appeals log", owner: "Legal", status: "gap", note: "No standing channel for affected persons to contest a decision." },
];
