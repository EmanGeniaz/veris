...
export const CROSSWALK = [
  ...
  { id: "C12", domain: "Data", capability: "Personal-data protection & residency", euai: "Art. 10(5) · GDPR", nist: "MANAGE 2.2", iso: "A.7 · ISO 27701", sg: "Data quality", artifact: "DPIA + transfer mapping", owner: "CDPO", status: "progress", note: "Transfer impact assessment in flight — closes the APAC Art. 44 gap (INC-1048)." },
  ...
  { id: "C18", domain: "Model & Technical", capability: "Explainability & interpretability", euai: "Art. 13", nist: "MEASURE 2.9", iso: "A.8.2", sg: "Stakeholder interaction", artifact: "Explainability record", owner: "CAIO", status: "progress", note: "Explainability record in flight — reason codes for adverse credit decisions (closes RSK-005)." },
  ...
  { id: "C27", domain: "Operations & Lifecycle", capability: "Drift & change management", euai: "Art. 72", nist: "MEASURE 2.4", iso: "A.6.2.5", sg: "Operations mgmt", artifact: "Drift monitoring configuration", owner: "Model Risk", status: "progress", note: "Wiring the 2 remaining production models to drift monitoring (Art. 72)." },
