...
export const GAP_CLOSURES = [
  ...
  { ref: "C12", capability: "Personal-data protection & residency", artifact: "DPIA + transfer mapping",       owner: "Priya Mehta · CDPO",     action: "Complete the Art. 44 transfer impact assessment for the APAC flow.",   clears: "INC-1048 · APAC cross-border transfer gap", euai: "GDPR Art. 44", target: "Sep 2026" },
  { ref: "C18", capability: "Explainability & interpretability",  artifact: "Explainability record",          owner: "Leila Haddad · CAIO",    action: "Produce reason codes and a model-behaviour statement for adverse credit decisions.", clears: "RSK-005 · explainability gap on Credit Decision", euai: "Art. 13", target: "Sep 2026" },
  { ref: "C27", capability: "Drift & change management",          artifact: "Drift monitoring configuration", owner: "D. Osei · Model Risk",   action: "Wire the two remaining production models to drift monitoring.",        clears: "2 production models not on drift monitoring", euai: "Art. 72",    target: "Aug 2026" },
];
