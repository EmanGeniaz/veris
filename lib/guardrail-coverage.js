...
export const GUARDRAIL_LAYERS = [
  {
    ...
    controls: [
      ...
      { name: "Malware & file scanning", status: "partial", note: "Deterministic checks — executable magic bytes (PE / ELF / Mach-O), dangerous and double extensions — block obvious malware, but this is not a full AV engine or sandbox detonation." },
    ],
  },
  {
  ...
  },
  {
    ...
    controls: [
      ...
      { name: "Trust scoring", status: "partial", note: "Every source carries a trust score that weights ranking (relevance × trust × recency) — but tiers are inferred from the source string by pattern, not a signed source registry with provenance." },
    ],
  },
  {
