...
export const GUARDRAIL_LAYERS = [
  ...
  },
  {
    ...
    controls: [
      ...
      { name: "Hallucination checks", status: "partial", note: "Grounding, citations, \"never invent data\" and a groundedness heuristic (figures checked against retrieved context) reduce hallucination — but this is a heuristic, not a full factuality verifier." },
    ],
  },
];
