...
export const ROLE_CENTERS = {
  ...
  employee: {
    ...
    surfaces: [
      ...
      { id: "emp_reports", label: "My Reports", sub: "Build a report on your AI activity by dimension and export.", blocks: [
        { t: "report", eye: "Report builder", h3: "My AI report", dims: ["AI usage", "Hours saved & impact", "Tasks & requests", "Risk & compliance", "By activity", "By time"] } ] },
