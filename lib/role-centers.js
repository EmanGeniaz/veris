...
export const ROLE_CENTERS = {
  ...
  employee: {
    ...
    surfaces: [
      ...
      { id: "emp_projects", label: "My Projects", sub: "How your work connects to enterprise AI initiatives — and where you can propose a new one.", blocks: [
        { t: "newproject", eye: "Start something new", h3: "Propose a new AI project", body: "Have an idea for an AI project? Submit it here. New projects need your manager's approval before they become an active, governed initiative — so it goes to their queue first." },
      ...
      { id: "emp_usage", label: "AI Usage", sub: "Your analytics and impact — sessions, hours saved, top skills and productivity trend.", blocks: [
        { t: "text", eye: "AI Usage", h3: "Your usage and impact", body: "See your sessions, hours saved, tokens, cost, most-used tools and top skills — the measurable answer to whether AI is helping you, all in one dashboard." } ] },
      ...
      { id: "emp_learning", label: "Governance Academy", sub: "Your learning hub, prompt library and knowledge vault — one place to learn, reuse and reference.", blocks: [
        { t: "text", eye: "Governance Academy", h3: "Learn, reuse and reference — in one place", body: "Your learning path adapts to how you actually work. Alongside it, your Prompt Library (reusable, governed prompts) and the Knowledge Vault (permission-checked org knowledge) live here too." } ] },
