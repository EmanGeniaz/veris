...
export const ROLE_CENTERS = {
  ...
  ciso: {
    ...
    kpis: [["Security posture", "79", "good", "/100 · +3 QoQ"], ["Threats blocked", "2,410", "gold", "prompt-inj · jailbreak"], ["Open vulnerabilities", "3", "warn", "1 critical · 1 high"], ["Data-leak events", "0", "good", "30d · monitors green"], ["Guardrail coverage", "86%", "info", "of production models"], ["MTTR", "3.1h", "good", "P1 mean-time-to-respond"]],
    panels: [
