  ...
  ciso: {
    ...
    surfaces: [
      ...
      { id: "ciso_guardlayers", label: "Guardrail Layers", sub: "The 7 guardrail layers every agentic stack needs — honest Enforced / Partial / Gap coverage, mapped to real engines.", blocks: [
        { t: "text", eye: "Guardrails", h3: "7 guardrail layers, honestly scored", body: "Input · Prompt · Retrieval · Memory · Runtime · Tool · Output — every sub-control scored against what VerisZone actually enforces in code, and mapped to the engine behind it. Not a green wall: some engines are strong, some run on seeded signals, some layers are not built yet." } ] },
  ...
  cgo: {
    ...
    surfaces: [
      ...
      { id: "cgo_guardlayers", label: "Guardrail Layers", sub: "The 7 guardrail layers every agentic stack needs — honest Enforced / Partial / Gap coverage, mapped to real engines.", blocks: [
        { t: "text", eye: "Guardrails", h3: "7 guardrail layers, honestly scored", body: "Input · Prompt · Retrieval · Memory · Runtime · Tool · Output — every sub-control scored against what VerisZone actually enforces in code, and mapped to the engine behind it. The honest headline of what the platform's guardrails do and do not cover." } ] },
