/* ── Regional regulation → control mappings (China · Brazil · South Korea) ──
   ...
   mapping each regulation's core requirements to a control GenVeris already
...
export const BR_REQS = [
  ...
  { n: 4, name: "Algorithmic impact assessment", desc: "Assess impact of high-risk AI.", control: "Impact Assessment register — algorithmic impact assessment per high-risk system, computed completeness", surface: "Impact Assessments", status: "Met" },
...
export const KR_REQS = [
  ...
  { n: 7, name: "Impact assessment", desc: "Assess impact of high-impact AI.", control: "Impact Assessment register — high-impact AI assessment per system, computed completeness", surface: "Impact Assessments", status: "Met" },
];
