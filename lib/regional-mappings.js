...
export const UK_REQS = [
  ...
  { n: 2, name: "Appropriate transparency & explainability", desc: "Communicate when and how AI is used and explain its decisions.", control: "AI interaction disclosure + decision transparency + Art.12 record", surface: "Article 12 Log", status: "Partial" },
...
export const CA_REQS = [
  ...
  { n: 3, name: "Transparency notice", desc: "Notify affected individuals that a decision is automated.", control: "AI interaction disclosure + decision transparency", surface: "Decisions / Approvals", status: "Partial" },
...
export const JP_REQS = [
  ...
  { n: 6, name: "Transparency & accountability", desc: "Explain AI use and maintain accountability.", control: "Article 12 record + disclosure + EOS ownership", surface: "Article 12 Log", status: "Partial" },
