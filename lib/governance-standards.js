/* ── Governance-stack standards → control mappings (ISO 37000/38500/38505) ──
   ...
   GenVeris operates the AI tier (38507) deeply and covers a real slice of data
...
/* The nested governance lineage — corporate → IT → data → AI. `scope` says how
   far GenVeris reaches into each tier; the enterprise owns the broader tiers. */
export const GOVERNANCE_LINEAGE = [
  ...
  { id: "iso-38505", tier: "Data",      label: "ISO 38505", sub: "Governance of data",            scope: "Full",      owner: "GenVeris gateway" },
  { id: "iso-38507", tier: "AI",        label: "ISO 38507", sub: "Governance of AI",              scope: "Full",      owner: "GenVeris core" },
];
