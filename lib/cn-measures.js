...
export const CN_REQS = [
  ...
  { n: 3,  name: "Explicit AI-content labelling", inst: "labelling", desc: "Visible label on AI-generated text, image, audio and video shown to users.", control: "AI interaction disclosure + generated-content label on output", surface: "Article 12 Log", status: "Partial" },
  ...
  { n: 5,  name: "Lawful, IP-clean training data", inst: "genai", desc: "Training corpus from lawful sources with respect for IP and personal-data consent.", control: "Data governance record + provenance on the model card", surface: "AI Central · Repository", status: "Partial" },
