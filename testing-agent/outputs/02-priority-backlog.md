...
| High | Verified | Glyph corruption | `components/GenVerisPlatform.jsx:5`, `:239`, `:1332` | Replace corrupted text/icons; remove encoding-damaged comments/strings |
...
| High | Verified | No real RBAC boundary | `GenVeris` local `role`, `sessionMode`; no middleware/API inspected | Add permission model before pilot/production claims |
| High | Verified | Monolithic app component | `components/GenVerisPlatform.jsx` | Split shell, login, AI Central, CXO, profile, HITL modules |
