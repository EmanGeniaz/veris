...
export function ExecAssistant({role,goto,showToast,isMobile,tab}){
  ...
  const answer=text=>{
    ...
    if(/help|what can|who are/.test(t))return {text:`I am Veris Intelligence, your Executive Advisor. I watch your priorities, decisions, risks and evidence across GenVeris and reason over internal knowledge first - external models are used for reasoning only, never trained on your data.`,src:"Internal",srcNote:"Platform knowledge"};
