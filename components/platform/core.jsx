...
/* Section — self-hosted fonts (air-gap safe: no runtime fetch to a font CDN).
   The two families the design system actually references are Manrope (the
   working sans, ~95% of the UI) and DM Serif Display (the editorial accent).
   Latin + latin-ext woff2 subsets are committed under /public/fonts and served
   from the app's own origin; the per-subset unicode-range means a browser only
   downloads the subset it needs. Non-Latin text (e.g. Arabic/RTL) has always
   fallen through to the system sans stack — neither family ships those glyphs —
   so behaviour is unchanged. (JetBrains Mono was imported here but never
   referenced by any font stack — dropped.) */
export const FONTS = `
@font-face{font-family:'Manrope';font-style:normal;font-weight:300 800;font-display:swap;src:url('/fonts/manrope-normal-300_800-latin.woff2') format('woff2');unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD;}
@font-face{font-family:'Manrope';font-style:normal;font-weight:300 800;font-display:swap;src:url('/fonts/manrope-normal-300_800-latin-ext.woff2') format('woff2');unicode-range:U+0100-02BA,U+02BD-02C5,U+02C7-02CC,U+02CE-02D7,U+02DD-02FF,U+0304,U+0308,U+0329,U+1D00-1DBF,U+1E00-1E9F,U+1EF2-1EFF,U+2020,U+20A0-20AB,U+20AD-20C0,U+2113,U+2C60-2C7F,U+A720-A7FF;}
@font-face{font-family:'DM Serif Display';font-style:normal;font-weight:400;font-display:swap;src:url('/fonts/dm-serif-display-normal-400-latin.woff2') format('woff2');unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD;}
@font-face{font-family:'DM Serif Display';font-style:normal;font-weight:400;font-display:swap;src:url('/fonts/dm-serif-display-normal-400-latin-ext.woff2') format('woff2');unicode-range:U+0100-02BA,U+02BD-02C5,U+02C7-02CC,U+02CE-02D7,U+02DD-02FF,U+0304,U+0308,U+0329,U+1D00-1DBF,U+1E00-1E9F,U+1EF2-1EFF,U+2020,U+20A0-20AB,U+20AD-20C0,U+2113,U+2C60-2C7F,U+A720-A7FF;}
...
/* ── Workspace palettes ─────────────────────────────────────────────
   GenVeris runs in light mode only. The palette picker (Workspace
...
/* Mutate the shared T object in place — components read T at render, and
   GenVerisPlatform bumps a nonce so a palette change repaints the tree. */
...
export const USER_PROFILES = {
  demo:{name:"Demo Center",email:"demo.center@genveris.ai",role:"Demo Center",title:"Sales Demo Workspace",department:"Solution Engineering",organization:"GenVeris Demo Center",phone:"+1 415 555 0199",region:"Global",timezone:"UTC",manager:"Revenue and Product Leadership",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 15:30"},
  ceo:{name:"Maya Chen",email:"maya.chen@genveris.ai",password:"GenVeris-CEO-2026",role:"CEO",title:"Chief Executive Officer",department:"Executive Office",organization:"GenVeris Executive Committee",phone:"+1 415 555 0188",region:"Global",timezone:"America/New_York",manager:"Board of Directors",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 08:15"},
  coo:{name:"Priya Mehta",email:"priya.mehta@genveris.ai",password:"GenVeris-COO-2026",role:"COO",title:"Chief Operating Officer",department:"Enterprise Operations",organization:"GenVeris Operating Office",phone:"+1 415 555 0144",region:"Global",timezone:"America/Los_Angeles",manager:"Executive Committee",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 08:31"},
  cfo:{name:"Elena Rossi",email:"elena.rossi@genveris.ai",password:"GenVeris-CFO-2026",role:"CFO",title:"Chief Financial Officer",department:"Finance and Value Realization",organization:"GenVeris Finance Office",phone:"+39 02 555 0162",region:"EU / US",timezone:"Europe/Rome",manager:"Audit and Finance Committee",ssoStatus:"Ready",evidenceRetention:"10 years",lastLogin:"2026-06-19 09:18"},
  chro:{name:"Hannah Lee",email:"hannah.lee@genveris.ai",password:"GenVeris-CHRO-2026",role:"CHRO",title:"Chief Human Resources Officer",department:"People and Transformation",organization:"GenVeris People Office",phone:"+1 415 555 0137",region:"Global",timezone:"America/Los_Angeles",manager:"Executive Committee",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 09:27"},
  ciso:{name:"Jordan Sinclair",email:"jordan.sinclair@genveris.ai",password:"GenVeris-CISO-2026",role:"CISO",title:"Chief Information Security Officer",department:"Security Governance",organization:"GenVeris Global Trust Office",phone:"+1 415 555 0101",region:"US / EU",timezone:"America/New_York",manager:"Enterprise Risk Committee",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 09:05"},
  caio:{name:"Aisha Patel",email:"aisha.patel@genveris.ai",password:"GenVeris-CAIO-2026",role:"CAIO",title:"Chief AI Officer",department:"AI Governance",organization:"GenVeris Global AI Office",phone:"+1 415 555 0128",region:"US / EU",timezone:"America/Los_Angeles",manager:"Board AI Risk Committee",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 09:42"},
  cio:{name:"Marcus Reid",email:"marcus.reid@genveris.ai",password:"GenVeris-CIO-2026",role:"CIO",title:"Chief Information Officer",department:"Enterprise Technology",organization:"GenVeris Digital Platforms",phone:"+44 20 7946 0184",region:"UK / EU",timezone:"Europe/London",manager:"Executive Technology Council",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 08:50"},
  cdpo:{name:"Niamh Lynch",email:"niamh.lynch@genveris.ai",password:"GenVeris-CDPO-2026",role:"CDPO",title:"Chief Data Privacy Officer",department:"Privacy and Data Protection",organization:"GenVeris Privacy Office",phone:"+353 1 555 0198",region:"EU",timezone:"Europe/Dublin",manager:"Data Protection Board",ssoStatus:"Ready",evidenceRetention:"10 years",lastLogin:"2026-06-19 10:11"},
  cgo:{name:"Rafael Torres",email:"rafael.torres@genveris.ai",password:"GenVeris-CGO-2026",role:"CGO",title:"Chief Governance Officer",department:"Governance, Risk and Compliance",organization:"GenVeris Governance Office",phone:"+1 212 555 0176",region:"US / LATAM",timezone:"America/New_York",manager:"Audit and Risk Committee",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 07:38"},
  cro:{name:"Deepa Nair",email:"deepa.nair@genveris.ai",password:"GenVeris-CRO-2026",role:"CRO",title:"Chief Risk Officer",department:"Enterprise Risk Management",organization:"GenVeris Risk Office",phone:"+1 617 555 0159",region:"US / EU",timezone:"America/New_York",manager:"Board Risk Committee",ssoStatus:"Ready",evidenceRetention:"10 years",lastLogin:"2026-06-19 07:52"},
  legal:{name:"Thomas Beck",email:"thomas.beck@genveris.ai",password:"GenVeris-LEGAL-2026",role:"Legal",title:"General Counsel & Compliance",department:"Legal, Regulatory and Compliance",organization:"GenVeris Office of General Counsel",phone:"+49 89 555 0133",region:"EU / US",timezone:"Europe/Berlin",manager:"Board Governance Committee",ssoStatus:"Ready",evidenceRetention:"10 years",lastLogin:"2026-06-19 08:04"},
  aicentral:{name:"AI Central",email:"ai.central@genveris.ai",role:"AI Central",title:"Execution and Assurance Workspace",department:"AI Central Operations",organization:"GenVeris AI Operating Center",phone:"+1 415 555 0150",region:"Global",timezone:"UTC",manager:"AI Transformation Office",ssoStatus:"Ready",evidenceRetention:"7 years",lastLogin:"2026-06-19 15:40"},
  employee:{name:"Jamie Park",email:"jamie.park@genveris.ai",role:"Employee",title:"Product Engineer",department:"Engineering",organization:"GenVeris Enterprise",phone:"+1 415 555 0171",region:"US",timezone:"America/Los_Angeles",manager:"Riley Chen",ssoStatus:"Ready",evidenceRetention:"90 days",lastLogin:"2026-07-21 09:10"},
  manager:{name:"Riley Chen",email:"riley.chen@genveris.ai",role:"Manager",title:"Engineering Manager",department:"Engineering",organization:"GenVeris Enterprise",phone:"+1 415 555 0164",region:"US",timezone:"America/Los_Angeles",manager:"Priya Mehta",ssoStatus:"Ready",evidenceRetention:"90 days",lastLogin:"2026-07-21 08:45"},
};
...
export const CAIO_NAV = [
  ...
  {id:"caio_guardlayers", icon:"G", label:"Guardrail Layers"},
  {id:"caio_hallucination", icon:"H", label:"Hallucination Monitor"},
];
...
export const CAIO_NAV_SECTIONS = [
  {title:"AI Governance Office", items:["home","caioplaybook","caiogov","caioreports","caioincidents","caioaia","caiorisk","caiolibrary","caio_crosswalk","caio_soa","caio_templates","caio_drift","caio_guardlayers","caio_hallucination"]},
...
export const ONBOARD = {
  caio:[
    ...
    {id:4,title:"Understand the HITL workflow",tag:"Protocol",time:"10 min",urgent:false,desc:"ISO 42001 Clause 8.1 requires operational controls for AI decisions. Every high-stakes action requires your explicit approval before GenVeris can act."},
...
export function BrandLogo({theme,width=160,style={}}) {
  const src=theme==="dark"?"/brand/genveris-dark-transparent.png":"/brand/genveris-light-blue-gold.png";
  const filter=theme==="dark"?"contrast(1.04) saturate(1.04)":"contrast(1.06) saturate(1.04)";
  return <img src={src} alt="GenVeris" width={width} style={{width,height:"auto",objectFit:"contain",display:"block",filter,...style}}/>;
}
...
export const TRUST_CENTER_DATA = {
  ...
  questionnaires:[
    ...
    {name:"Custom Enterprise",desc:"GenVeris custom enterprise security questionnaire",pages:24,time:"60 min",status:"Available"},
  ],
  policies:[
...
export const LOGIN_PROFILES = [
  {id:"demo",label:"Demo Center",role:"caio",target:"home",mode:"demo",accent:"#5B8CFF",title:"GenVeris Demo Center",subtitle:"A seeded sales showcase of the Enterprise AI Transformation Control Plane, from CXO strategy to AI Central execution and AI Spine scale decisions.",email:"demo.center@genveris.ai",kpis:[["13","Role workspaces"],["138","Governed surfaces"],["Live","AI Spine"]]},
  {id:"ceo",label:"CEO",role:"ceo",target:"home",accent:"#D6A84F",title:"CEO Enterprise AI Command",subtitle:"Board-level AI transformation, enterprise maturity, strategic risk, value realization and scale/no-scale decisions.",email:"maya.chen@genveris.ai",kpis:[["78/100","AI maturity"],["2","Scale-ready"],["$3.6M","Value realized"]]},
  {id:"coo",label:"COO",role:"coo",target:"home",accent:"#0EA5E9",title:"COO AI Operating Model",subtitle:"Department rollout health, adoption, operating exceptions, process change and pilot-to-scale execution.",email:"priya.mehta@genveris.ai",kpis:[["4","Pilots"],["64%","Adoption"],["3","Blocked tasks"]]},
  {id:"cfo",label:"CFO",role:"cfo",target:"home",accent:"#22C55E",title:"CFO AI Value Office",subtitle:"Budget governance, ROI confidence, value evidence, benefit realization and investment gate approvals.",email:"elena.rossi@genveris.ai",kpis:[["88%","ROI confidence"],["6%","Budget variance"],["14 mo","Payback"]]},
  {id:"chro",label:"CHRO",role:"chro",target:"home",accent:"#EC4899",title:"CHRO Workforce AI Readiness",subtitle:"Workforce readiness, adoption resistance, AI literacy, role impact and responsible people transformation.",email:"hannah.lee@genveris.ai",kpis:[["68%","Training"],["72%","Role impact"],["77%","AI literacy"]]},
  {id:"ciso",label:"CISO",role:"ciso",target:"home",accent:"#3B82F6",title:"CISO Security Governance",subtitle:"Security posture, third-party AI exposure, incident oversight, ISO 27001 alignment and control evidence.",email:"jordan.sinclair@genveris.ai",kpis:[["18","Controls"],["6","Open risks"],["91%","SOC 2"]]},
  {id:"caio",label:"CAIO",role:"caio",target:"home",accent:"#8B5CF6",title:"CAIO Governance Command",subtitle:"AI strategy, risk appetite, model oversight, board reporting and responsible AI operating cadence.",email:"aisha.patel@genveris.ai",kpis:[["72/100","Maturity"],["8","Active risks"],["7","HITL approvals"]]},
  {id:"cio",label:"CIO",role:"cio",target:"home",accent:"#06B6D4",title:"CIO AI Portfolio Control",subtitle:"AI systems portfolio, implementation roadmap, platform controls, data readiness and enterprise adoption.",email:"marcus.chen@genveris.ai",kpis:[["47","AI assets"],["12","Roadmap items"],["79%","Controls"]]},
  {id:"cdpo",label:"CDPO",role:"cdpo",target:"home",accent:"#14B8A6",title:"CDPO Privacy Oversight",subtitle:"DPIAs, GDPR Article 22, data processing controls, consent evidence and regulatory response readiness.",email:"elena.rossi@genveris.ai",kpis:[["11","DPIAs"],["83%","GDPR"],["4","Deadlines"]]},
  {id:"cgo",label:"CGO",role:"cgo",target:"home",accent:"#F59E0B",title:"CGO Governance Office",subtitle:"Policy lifecycle, framework mapping, approvals, escalations and assurance reporting for leadership.",email:"rafael.torres@genveris.ai",kpis:[["24","Policies"],["61%","ISO 42001 A"],["9","Reports"]]},
  {id:"cro",label:"CRO",role:"cro",target:"home",accent:"#E0654E",title:"CRO Enterprise Risk",subtitle:"AI risk appetite, enterprise risk register, control effectiveness, key risk indicators and audit readiness.",email:"deepa.nair@genveris.ai",kpis:[["Amber","AI risk"],["88%","Controls"],["1","Critical risk"]]},
  {id:"legal",label:"Legal",role:"legal",target:"home",accent:"#8B6FE0",title:"Legal & Compliance",subtitle:"Regulatory obligations, EU AI Act conformity, AI vendor contracts, IP provenance and legal defensibility.",email:"thomas.beck@genveris.ai",kpis:[["88%","Defensible"],["1","Conformity gap"],["5","Frameworks"]]},
  {id:"employee",label:"Employee",role:"employee",target:"myworkspace",accent:"#2BA88A",title:"My AI Workspace",subtitle:"One governed workbench for every AI interaction - approved models, enterprise knowledge and automatic compliance, faster than any public chat.",email:"jamie.park@genveris.ai",kpis:[["84","Prompts governed"],["11.5h","Time saved"],["0","Data leaks"]]},
  {id:"manager",label:"Manager",role:"manager",target:"teamspace",accent:"#0EA5E9",title:"Team AI Workspace",subtitle:"Team adoption, value and compliance without reading private prompts - aggregates only, by policy.",email:"riley.chen@genveris.ai",kpis:[["64%","Team adoption"],["92%","Compliance"],["3","Blocked events"]]},
  {id:"aicentral",label:"AI Central",role:"caio",target:"aicentral",mode:"aicentral",accent:AI_GOLD,title:"AI Central Demo",subtitle:"The seeded Enterprise AI Command Center - initiative digital twins, AI PMO, model registry, governance, evidence, policies and the AI Gateway, without the CXO workspaces.",email:"ai.central@genveris.ai",kpis:[["4","Initiatives"],["8","AI models"],["Live","Gateway"]]},
  {id:"superadmin",label:"Super Admin",role:"superadmin",target:"superadmin",mode:"superadmin",accent:"#D6A84F",title:"Platform Administration",subtitle:"The platform-operator console: provision organizations, enable modules per org and role, define users and RBAC, and set org-wide policies that cascade to every level. Enable & override, not author.",email:"root@genveris.ai",kpis:[["3","Organizations"],["138","Surfaces"],["RBAC","Per-user"]]}
];
