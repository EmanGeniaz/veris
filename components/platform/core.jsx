...
export const LOGIN_PROFILES = [
  ...
  {id:"superadmin",label:"Super Admin",role:"superadmin",target:"superadmin",mode:"superadmin",accent:"#D6A84F",title:"Platform Administration",subtitle:"The platform-operator console: provision organizations, enable modules per org and role, define users and RBAC, and set org-wide policies that cascade to every level. Enable & override, not author.",email:"root@veriszone.ai",kpis:[["3","Organizations"],["35","Modules"],["RBAC","Per-user"]]}
];
